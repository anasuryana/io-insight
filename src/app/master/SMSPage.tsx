...
import DialogSMSPage from "./DialogSMSPage"
...
export default function SMSPage() {
    ...
    return (
        <>
                    ...
                    <Breadcrumb>
                        <BreadcrumbList>
                            <BreadcrumbItem className="md:block">
                                <BreadcrumbLink href="#">SMS Master</BreadcrumbLink>
                            </BreadcrumbItem>
                        </BreadcrumbList>
                    </Breadcrumb>
                </header>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-1 mb-3 flex-shrink-0">
                        ...
                        <div className="rounded-lg p-2 flex items-center">
                            <div className="grid w-full max-w-sm items-center gap-1">
                                ...
                                <Input type="text" id="phone_number" placeholder="Phone Number" value={phone} onChange={(e) => setPhone(e.target.value)} />
                            </div>
                        </div>
                    </div>
            ...
            <DialogSMSPage open={showFindModal} onClose={() => setShowFindModal(false)}
                setParentId={setRowId} setParentName={setName}
                setParentPhone={setPhone} setParentStatus={setStatus}
